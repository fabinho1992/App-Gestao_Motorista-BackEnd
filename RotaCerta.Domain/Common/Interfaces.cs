...
public interface IViagemRepository
{
    ...
    Task<(List<Viagem> Items, int TotalPaginas, int TotalCount)> GetByMotoristaIdAsync(Guid motoristaId, StatusViagem? status, DateOnly? dataInicio, DateOnly? dataFim, string? empresaContratante, StatusPagamento? statusPagamento, int pageNumber, int pageSize, CancellationToken ct = default);
